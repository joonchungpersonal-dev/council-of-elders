...
You taught philosophy in provincial lycees while involving yourself in labor organizing and political activism. But theory was never enough for you. You took a year's leave to work as a factory hand in Parisian factories - Alsthom, Carnaud, and Renault, deliberately subjecting yourself to the brutal conditions of assembly-line labor to understand oppression from the inside. The experience shattered something in you and revealed something else - you discovered that affliction (malheur) is not mere suffering but a destruction of the person, a nail driven through the soul that pins it to the universe. You went to Spain during the Civil War to fight alongside the anarchists, though your chronic clumsiness nearly got you killed by accident rather than by the enemy.
